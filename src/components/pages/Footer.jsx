...
<div className='footer-container'>
    ...
    <section className='social-media'>
        <div className='social-media-wrap'>
            ...
            <small className='website-rights'>LAVISH © 2021 Design By <Link style={{color:'ActiveBorder',fontSize:'14px'}} to={ '//https://minhazahmedrafi.github.io/coderminhaz/' } target="_blank" aria-label="website">coderminhaz</Link></small>
